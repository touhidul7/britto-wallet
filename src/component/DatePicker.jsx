...
export default function DatePicker() {
  ...
  return (
    <section className="bg-white dark:bg-dark mb-7">
              ...
              <div className="relative" ref={datepickerRef}>
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full border border-stroke bg-transparent py-2.5 pl-[50px] pr-8 text-dark-2 outline-none transition focus:border-primary dark:border-dark-3 dark:text-dark-6 dark:focus:border-primary"
                    value={updateInput()}
